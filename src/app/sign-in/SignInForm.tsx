...
export function SignInForm({ hasGoogleAuth }: SignInFormProps) {
    ...
    <div className="min-h-screen bg-paper-50 px-6 py-16">
      <div className="mx-auto max-w-md">
        <div className="paper-card rounded-3xl p-8">
          <p className="title-tag">Sign in</p>
          <h1 className="mt-5 font-display text-4xl text-ink">アカウントにログイン</h1>
          <p className="mt-4 text-sm leading-7 text-ink-soft">
            保存したしおりの確認、共有リンク、PDF 出力はログイン後に使えます。
          </p>
          ...
          <p className="mt-6 text-center text-sm text-ink-soft">
            はじめて使う場合は{" "}
            <Link href="/sign-up" className="text-accent-coral underline-offset-4 hover:underline">
              新規登録
            </Link>
          </p>
        </div>
